...
function getPreviousValidIndex(index, length) {
  const depractedIndex = index - 1;
  return depractedIndex < 0 ? length - 1 : depractedIndex;
}
...
export default {
  ...
  computed: {
    ...
    selectedRobot() {
      return {
        ...
        rightArm: availableParts.arms[this.selectedRigthArmIndex],
  ...
  methods: {
    ...
    selectNextRightArm() {
      this.selectedRigthArmIndex = getNextValidIndex(
        this.selectedRigthArmIndex,
        availableParts.arms.length,
      );
    },
    selectPreviousRightArm() {
      this.selectedRigthArmIndex = getPreviousValidIndex(
        this.selectedRigthArmIndex,
        availableParts.arms.length,
      );
    },
